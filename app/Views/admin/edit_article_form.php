...
<head>
    ...
    <title><?= esc($pageTitle ?? 'Edit Artikel') ?></title>
    ...
    <div class="content">
        ...
        <div class="form-container">
            <?php if (isset($article)): ?>
                <form action="<?= base_url('admin/articles/edit/' . esc($article['id'])) ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    ...
                    <?php if ($article['image']): ?>
                        ...
                        <p><i>Abaikan jika tidak ingin mengubah gambar.</i></p>
                    <?php else: ?>
                        <p>Tidak ada gambar saat ini.</p>
                    <?php endif; ?>
                    <label for="image">Ganti Gambar Artikel:</label>
